...
#####  EXAMPLES  #####
######################
Import-Module $PSScriptRoot+"\..\public\new-WEBpage.ps1" -Force
Import-Module $PSScriptRoot+"\..\public\new-WEBtable.ps1" -Force
Import-Module $PSScriptRoot+"\..\public\new-WEBtabcontainer.ps1" -Force
Import-Module $PSScriptRoot+"\..\public\new-WEBtab.ps1" -Force
Import-Module $PSScriptRoot+"\..\public\new-WEBcarouselcontainer.ps1" -Force
Import-Module $PSScriptRoot+"\..\public\new-WEBcarouselitem.ps1" -Force
Import-Module $PSScriptRoot+"\..\public\new-WEBAccordion.ps1" -Force
Import-Module $PSScriptRoot+"\..\public\new-WEBAccordionItem.ps1" -Force
