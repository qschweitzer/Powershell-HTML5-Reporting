...
## Source code
``` powershell
$TestPage = New-WEBPage -Title "MY FIRST TEST" -Content {
  New-WEBTabContainer -Tabs {
    New-WEBTab -Name "First Tab" -Content {
      New-WEBCardHeader -BackgroundColor "#fff" -Center -Content {
        New-WEBTitles -TitleText "Hi, I'm generated on a Windows PC with a Powershell script." -Size 1 -Center
      }
      New-WEBRow -Content {
        New-WEBColumn -Content {
          New-WEBCard -Content {
            New-WEBTitles -Size 2 -TitleText "This HTML skin is based on $(New-WEBTextFormat -Bold "PicoCSS framework") and $(New-WEBTextFormat -Bold "Bootstrap!") For the $(New-WEBTextFormat -ColorHexa "#BF0413" -Highlight "charts"), it's $(New-WEBTextFormat -Bold "ChartJS!") And for dynamic tables PSReport use $(New-WEBTextFormat -Bold "Bootstrap-tables.")."
      ...
      New-WEBRow -Content {
        New-WEBColumn -Content {
          New-WEBCard -BackgroundColor "#F2EADF" -Content {
            New-WEBTitles -Size 3 -TitleText "That's a card" -Center
        ...
        New-WEBColumn -Content {
          New-WEBCard -BackgroundColor "#355070" -Content {
            New-WEBTitles -Size 3 -TitleText "Let's create some charts - NEW Stacked bars chart" -LightMode -Center
      ...
      New-WEBRow -Content {
        New-WEBColumn -Content {
          New-WEBCard -BackgroundColor "#6d597a" -Content {
            New-WEBTitles -Size 3 -TitleText "Disks capacity" -LightMode -Center
        ...
        New-WEBColumn -Content {
          New-WEBCard -BackgroundColor "#b56576" -Content {
            New-WEBTitles -Size 3 -TitleText "Doughnut Chart" -LightMode -Center
        ...
        New-WEBColumn -Content {
          New-WEBCard -BackgroundColor "#e56b6f" -Content {
            New-WEBTitles -Size 3 -TitleText "Pie Chart" -LightMode -Center
      ...
      New-WEBRow -Content {
        New-WEBColumn -Content {
          New-WEBCard -BackgroundColor "#F2935C" -Content {
            New-WEBTitles -Size 3 -TitleText "Line Chart" -LightMode -Center
        ...
        New-WEBColumn -Content {
          New-WEBCard -BackgroundColor "#eaac8b" -Content {
            New-WEBTitles -Size 3 -TitleText "Table with conditionnal format" -Center -LightMode
      ...
      New-WEBRow -Content {
        New-WEBColumn -Content {
          New-WEBCard -BackgroundColor "#fff" -Content {
            New-WEBTitles -Size 3 -TitleText "Search in a table" -Center
            ...
            New-WEBTable -ToTable (Get-Process | Group-Object -Property Name | Sort-Object Count -Descending | Select-Object Name, Count) -Pagination -DetailsOnClick -SortByColumn -ShowTooltip -EnableSearch -Exportbuttons -contextualcolor dark -Striped
          }
        }
      }
    }
    New-WEBTab -Name "Second Tab" -Content {
      New-WEBColumn -Content {
        New-WEBCard -BackgroundColor "#DFF2F2" -Content {
          New-WEBTitles -Size 3 -TitleText "List first 10 process"
