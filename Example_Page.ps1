      ...
      New-PWFRow -Content {
        New-PWFColumn -Content {
          New-PWFCard -Content {
            ...
            $(New-PWFTextFormat -YourText "Built with less 100 lines of code !" -Highlight -Keyboard)
          }
        }
      }
      New-PWFRow -Content {
        ...
        New-PWFColumn -Content {
          New-PWFCard -BackgroundColor "#355070" -Content {
            New-PWFTitles -Size 3 -TitleText "Let's create some charts - NEW Stacked bars chart" -LightMode
      ...
      New-PWFRow -Content {
        New-PWFColumn -Content {
          New-PWFCard -BackgroundColor "#6d597a" -Content {
            New-PWFTitles -Size 3 -TitleText "Disks capacity" -LightMode
      ...
      New-PWFRow -Content {
        New-PWFColumn -Content {
          New-PWFCard -BackgroundColor "#fff" -Content {
            ...
            New-PWFTable -ToTable (Get-Process | Group-Object -Property Name | Sort-Object Count -Descending | select Name, Count) -Pagination -DetailsOnClick -SortByColumn -ShowTooltip -EnableSearch -Exportbuttons
          }
        }
      }
    }
